...
interface TokenLogoProps {
  ...
  // Backing behind the icon. Defaults to white — right for most flat coin
  // marks. Pass 'transparent' when the glyph should sit directly on its
  // surface (e.g. inside AssetGlyph), so full-bleed coins fill the circle and
  // icons with baked-in transparent padding don't read as an unfilled ring.
  bg?: string;
}
...
// runtime.
export function TokenLogo({ symbol, size = 40, className = '', fallbackColor, bg = '#fff' }: TokenLogoProps) {
