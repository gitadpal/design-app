...
export function AdCampaigns({
  ...
  // Timer for active commitment — runs whenever a commitment exists so the main view banner stays live
  useEffect(() => {
    if (activeCommitment && !isFastForwarding) {
      const updateTimer = () => {
  ...
  const campaigns = [
    {
      ...
      description: 'Discover Space and Time — the ZK-proven data layer for smart contracts',
      reward: 110,
      duration: 8,
      poolRemaining: 64,
      completions: 3128,
    ...
    },
    {
      ...
      description: 'The Ethereum L2 built by Coinbase. 200+ apps, one ecosystem',
      reward: 95,
      duration: 6,
      poolRemaining: 71,
      completions: 2467,
    ...
    },
    {
      ...
      description: 'Powering Robinhood, Coinbase, and 600+ onchain apps',
      reward: 90,
      duration: 6,
      poolRemaining: 53,
      completions: 1845,
      ...
      endDate: '2026-04-19',
      tokenSymbol: 'ARB',
      tokenColor: 'from-blue-400 to-cyan-400',
    ...
    },
    {
      ...
      description: 'USDe: the fastest-growing dollar asset in crypto. $6B+ market cap',
      reward: 100,
      duration: 7,
      poolRemaining: 42,
      completions: 1253,
      ...
      endDate: '2026-04-17',
      tokenSymbol: 'ENA',
      tokenColor: 'from-purple-400 to-blue-500',
      network: 'Ethereum',
      networkColor: '#627EEA',
      networkIcon: '◆',
    },
    {
      id: 5,
      title: 'Kraken — Win a Whole Bitcoin',
      description: 'Trade, earn, and stake on the most trusted US exchange',
      reward: 75,
      duration: 5,
      poolRemaining: 38,
      completions: 982,
      ...
      endDate: '2026-04-24',
      tokenSymbol: 'BTC',
      tokenColor: 'from-orange-400 to-yellow-500',
      network: 'Bitcoin',
      networkColor: '#F7931A',
      networkIcon: '₿',
    },
    {
      id: 6,
      title: 'Aave — GHO, the DeFi Dollar',
      description: 'Borrow, lend, and mint GHO — the decentralized stablecoin native to Aave',
      reward: 80,
      duration: 4,
      poolRemaining: 58,
      completions: 1421,
      ...
      endDate: '2026-04-22',
      tokenSymbol: 'AAVE',
      tokenColor: 'from-pink-400 to-purple-500',
      network: 'Ethereum',
      networkColor: '#B6509E',
      networkIcon: '◆',
    },
    {
      id: 7,
      title: 'OKX Wallet — One Wallet, Every Chain',
      description: 'Self-custody across 80+ networks. Trade, swap, and stake in one place',
      reward: 70,
      duration: 5,
      poolRemaining: 76,
      completions: 2104,
      ...
      endDate: '2026-04-26',
      tokenSymbol: 'OKB',
      tokenColor: 'from-gray-700 to-black',
      network: 'Multi-chain',
      networkColor: '#000000',
      networkIcon: '⬢',
    },
  ...
  const bonusTasks = [
    { id: 1, title: 'Watch Kraken Brand Spot', points: 50, duration: '30 sec', icon: '🎥' },
    { id: 2, title: 'View Aave GHO Overview', points: 25, duration: '1 min', icon: '🌐' },
    { id: 3, title: 'Web3 Awareness Quiz', points: 100, duration: '3 min', icon: '📋' },
    { id: 4, title: 'Rate Ad Display Quality', points: 10, duration: '10 sec', icon: '⭐' },
  ];

  const participationHistory = [
    {
      id: 1,
      campaignTitle: 'Binance Launchpool — SXT',
      duration: 8,
      reward: 110,
    ...
    {
      id: 2,
      campaignTitle: 'Base — Onchain Summer 2026',
      duration: 6,
      reward: 95,
    ...
    {
      id: 3,
      campaignTitle: 'Arbitrum — The Scaling Layer',
      duration: 6,
      reward: 90,
    ...
    {
      id: 4,
      campaignTitle: 'Ethena — The Internet Bond',
      duration: 7,
      reward: 100,
    ...
    {
      id: 5,
      campaignTitle: 'Kraken — Win a Whole Bitcoin',
      duration: 5,
      reward: 75,
    ...
    {
      id: 6,
      campaignTitle: 'Aave — GHO, the DeFi Dollar',
      duration: 4,
      reward: 80,
      completedAt: '1 week ago',
      status: 'completed',
    ...
    {
      id: 7,
      campaignTitle: 'OKX Wallet — One Wallet, Every Chain',
      duration: 5,
      reward: 70,
    ...
    return (
      ...
      >
        ...
        <div className="relative z-[1]">
          ...
          {/* Featured campaign image with prism border */}
          <motion.div
            ...
            <div className="relative w-full max-w-[280px]">
              <div
                ...
                style={{
                  background: isComplete
                    ? 'linear-gradient(135deg, #00FFC2, #00d9a8)'
              ...
              >
                <img
                  ...
                  className="w-full aspect-[100/149] object-cover rounded-2xl block"
                  style={{ filter: 'contrast(1.04) brightness(0.98)' }}
                />
                {isComplete && (
                  <div className="absolute inset-0 rounded-2xl bg-gradient-to-t from-emerald-900/70 via-emerald-900/20 to-transparent flex items-center justify-center">
                    <motion.div
                      initial={{ scale: 0 }}
                      animate={{ scale: 1 }}
              ...
              <div className="h-2 rounded-full bg-white/10 overflow-hidden">
                <div
                  ...
                  style={{
                    width: `${progress}%`,
                    background: isComplete
                      ? 'linear-gradient(90deg, #00FFC2, #00d9a8)'
                      : 'linear-gradient(90deg, #00FFC2, #BC13FE)',
                  }}
                />
              </div>
            </div>
            ...
            {isComplete ? (
              ...
              >
                {isFastForwarding ? (
                  ...
                  <>
                    <Sparkles className="w-5 h-5" style={{ color: '#00FFC2' }} />
                    Fast Forward (Demo)
                  </>
                )}
              </button>
          ...
          >
            ...
            <span className="text-[11px] text-white/50">
              {daysLeft > 0 ? (
                ...
                <span className="text-red-400 font-semibold">Campaign ended</span>
              )}
            </span>
          </motion.div>
        </div>
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="bg-white border-b border-[#E0E0E0] sticky top-0 z-10">
          <div className="flex items-center justify-between px-4 py-3">
            ...
            <h2 className="text-base font-semibold tracking-tight text-[#1A1A1A]">Bonus Rewards</h2>
            <div className="w-12"></div>
          </div>
        </div>
    ...
    >
      ...
      <AnimatePresence>
        {activeCommitment && (
          ...
          >
            <Card
              className="gradient-earn text-white shadow-lg border-0 cursor-pointer transition-all hover:shadow-xl active:scale-[0.99]"
      ...
      >
        <button
          className="w-full text-left rounded-lg px-3 py-2.5 transition-all active:scale-[0.99] text-[#1A1A1A] border"
          style={{ background: 'rgba(0,255,194,0.10)', borderColor: 'rgba(0,255,194,0.35)' }}
          onClick={() => setView('bonus-rewards')}
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <Gift className="w-3.5 h-3.5" style={{ color: '#0a8a6b' }} />
              <span className="text-xs font-semibold">Bonus Rewards Available</span>
            </div>
            <ChevronRight className="w-3.5 h-3.5 text-[#1A1A1A]/60" />
          </div>
        </button>
      </motion.div>
      ...
      <div className="px-4">
        <div className="flex items-center justify-between mb-3">
          <h3 className="font-semibold tracking-tight text-[#1A1A1A]">Available Campaigns</h3>
        ...
        {campaigns.length === 0 ? (
          ...
          <div className="space-y-3">
            ...
            return (
              ...
              >
                <Card
                  className={`overflow-hidden border-[#E0E0E0] transition-all ${
                    locked
                      ? 'opacity-60 cursor-pointer'
                      : 'cursor-pointer hover:border-[#1A1A1A]/20 hover:shadow-sm'
                  }`}
                  onClick={() => {
                    if (locked) {
                      setShowEinkPrompt(true);
